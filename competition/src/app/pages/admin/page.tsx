            ...
            <tbody className="text-center text-black">
              {paginatedUploads.map((upload, index) => (
                ...
                >
                  ...
                  {/* Lien de téléchargement pour le fichier instru  */}
                  <td className="p-3 border-b">
                    <div className="flex justify-center">
                      <audio controls key={upload.instru}>
                        <source
                          src={`${`http://localhost:5000/${upload.instru}`}`}
                          type="audio/mp3"
                        />
                        {upload.mp3}
                      </audio>
                  ...
                  <td className="p-3 border-b">
                    <div className="flex justify-center">
                      <audio controls key={upload.music}>
                        <source
                          src={`${`http://localhost:5000/${upload.music}`}`}
                          type="audio/mp3"
                        />
                        {upload.mp3}
                      </audio>
                  ...
                  {/* Lien de téléchargement pour le fichier hira */}
                  <td className="p-3 border-b">
                    <div className="flex justify-center">
                      <audio controls key={upload.mp3}>
                        <source
                          src={`${`http://localhost:5000/${upload.mp3}`}`}
                          type="audio/mp3"
                        />
                        {upload.mp3}
                      </audio>
